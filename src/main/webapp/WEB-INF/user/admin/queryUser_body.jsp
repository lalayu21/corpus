<%@page import="com.corpus.entity.User"%>
            ...
            <tr>
                ...
                <c:choose>
                	<c:when test="${user.access == 1 }">
                		<td class="tableBody">审核通过</td>
                	</c:when>
                	<c:when test="${user.access == 2 }">
                		<td class="tableBody">未审核</td>
                	</c:when>
                	<c:otherwise>
                		<td class="tableBody">审核未通过</td>
                	</c:otherwise>
                </c:choose>
                ...
                <td class="tableBody">
                    <a href="changeInfo.html?id=${user.id }" target="_blank">修改</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
